...
The navigation is generated from your pages, you can take a look at the [`<AppNavbar>`](https://github.com/Atinux/content-windi-unocss/blob/main/components/AppNavbar.vue) component to see how it works.
...
export default defineAppConfig({
  socials: {
    twitter: 'Atinux',
    github: 'Atinux/content-windi-unocss'
...
See the `<MarkdownBlock>` component in [`components/content/MarkdownBlock.vue`](https://github.com/Atinux/content-windi-unocss/blob/main/.demo/components/content/MarkdownBlock.vue).
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2FAtinux%2Fcontent-windi-unocss-template) [![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/Atinux/content-windi-unocss-template)
...
You are at the end of the page, you can checkout the [about page](/about) or the [GitHub repository](https://github.com/Atinux/content-windi-unocss) and give a :icon{name="ph:star-duotone"}
