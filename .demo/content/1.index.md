...
```bash
npx nuxi init -t themes/content-windi-unocss my-website
```
...
The navigation is generated from your pages, you can take a look at the [`<AppNavbar>`](https://github.com/khaledOghli/content-windi-unocss/blob/main/components/AppNavbar.vue) component to see how it works.
...
You can configure Content Windi Unocss global configuration in the `app.config.ts` file:
...
export default defineAppConfig({
  socials: {
    twitter: 'khaledOghli',
    github: 'khaledOghli/content-windi-unocss'
  }
})
```
...
::markdown-block
\`\`\`ts
export default () => 'Hello Content Windi Unocss'
\`\`\`
::
...
See the `<MarkdownBlock>` component in [`components/content/MarkdownBlock.vue`](https://github.com/khaledOghli/content-windi-unocss/blob/main/.demo/components/content/MarkdownBlock.vue).
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/khaledOghli/content-windi-unocss) [![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/khaledOghli/content-windi-unocss)
...
You are at the end of the page, you can checkout the [about page](/about) or the [GitHub repository](https://github.com/khaledOghli/content-windi-unocss) and give a :icon{name="ph:star-duotone"}

Thanks for reading and happy writing, [khaledOghli](https://twitter.com/khaledOghli).
